...
class Dataset_UK_DALE_minute(Dataset):
    ...
    def __read_data__(self):
        ...
        for i in range(len(df_raw)):
            data_itved.append(sum(df_data_value[i * self.interval:(i + 1) * self.interval]))  ## 子集求和

        df_raw_type = data_itved[0:origin_dataset_len]  ## 从 data_itved 列表中取出前 origin_dataset_len 个元素，并将其赋值给 df_raw_type
        ...
        border2 = border2s[self.set_type]#8408
